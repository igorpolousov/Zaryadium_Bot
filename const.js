...
const btn_4Text = 'Извини за неудобства, если так произошло. Вытащи и вставь разъём провода повербанка повторно. Если это не помогло, то в течении 5 минут верни его бесплатно и возьми новый. Если остались вопросы, то <a href="https://t.me/zaryadium">напиши нам</a>'
...
// Сотрудничество
const btn_6Text = 'Если хочешь станцию в свою розничную точку или стать партнёром <a href="https://t.me/zaryadium">свяжись с нами</a> или <a href="mailto:partner@zaryadium.ru">partners@zaryadium.ru</a>'
